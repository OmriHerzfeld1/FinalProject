...
if __name__ == '__main__':
    ...
    #Multi SIM Full Data
    M_data_dir_t = r'C:\Users\omri.herzfeld\OneDrive - Bright Machines\Pictures\images for annotaion test\SIM\SIM - Original + Augmented'
    M_coco_t = r'C:\Users\omri.herzfeld\OneDrive - Bright Machines\Pictures\images for annotaion test\SIM\SIM_TrainAugmented + Original.json'
    M_data_dir_v = r'C:\Users\omri.herzfeld\OneDrive - Bright Machines\Pictures\images for annotaion test\SIM\SIM - Original + Augmented'
    M_coco_v = r'C:\Users\omri.herzfeld\OneDrive - Bright Machines\Pictures\images for annotaion test\SIM\SIM_ValidationAugmented + Original.json'
    M_type = "detection"
    ...
    # load model
    model = Model(model_name="fasterRCNN", pretrained=True, classes_num=3)
    ...
    train = Train(dataset=datasets, model=model, optimizer=optimizer, loss_func=loss_funct,
                  name="SIM_Augmented", batch_size=2, epoch=10, num_workers=4)
    train.train()
