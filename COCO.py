...
class Anno:
    def __init__(self, segmentation: list, area: int, bbox: list, iscrowd: int, id: int,
...
class Image:
    ...
    def add_anno(self, segmentation: list, area: int, bbox: list, iscrowd: int, id: int,
                 image_id: int, category_id : int):
        """
...
class Coco:
    ...
    def read_coco(self, im_folder_name: str = None):
        ...
        """
        coco_dict: dict = utilities.read_json(self.original_coco_dir)  # read coco file to dict
    ...
    def export_coco(self, final: str):
        ...
        utilities.write_json(os.path.dirname(self.original_coco_dir), coco_name, coco_dict)  # write coco file
